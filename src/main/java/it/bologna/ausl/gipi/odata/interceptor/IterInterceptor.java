            ...
            case CREATE:
                ...
                try {
                    ...
                    if (numeroIter != null && numeroIter > 0) {
                        ...
                        throw new OlingoRequestRollbackException("errore nella generazione del numero dell'iter");
                    }
                } catch (Exception ex) {
                    throw new OlingoRequestRollbackException("errore nella generazione del numero dell'iter", ex);
                }
                break;
        }
