...
public class GetUtentiGerarchiaStruttura extends EdmFunctionImportClassBase {
    ...
    public JPAQueryInfo getUtentiGerarchiaStruttura(
        ...
        log.info("Struttura: " + idStruttura);
        List<Integer> lista;
        ...
        queryDSL.select(QUtenteStruttura.utenteStruttura)
                ...
                .join(QPersona.persona).on(QUtente.utente.idPersona.eq(QPersona.persona))
                .join(QStruttura.struttura).on(QUtenteStruttura.utenteStruttura.idStruttura.eq(QStruttura.struttura))
                .where(QUtenteStruttura.utenteStruttura.idStruttura.id.in(lista)
                    .and(QStruttura.struttura.ufficio.eq(Boolean.FALSE)))//.or(QUtenteStruttura.utenteStruttura.idUtente.id.eq(idUtente)))
